 ...
 */
#ifndef YSXROUTE_HELPER_H
#define YSXROUTE_HELPER_H
 ...
 */
class YsxrouteHelper : public Ipv4RoutingHelper
{
public:
  /**
   ...
   * (Copy Constructor).
   */
  YsxrouteHelper (const YsxrouteHelper &);
...
private:
   ...
   * \return nothing
   */
  YsxrouteHelper &operator = (const YsxrouteHelper &);
